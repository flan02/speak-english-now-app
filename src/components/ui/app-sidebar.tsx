...
import Link from "next/link"; // <--- IMPORTANTE: Usamos Link en vez de <a>
import {
...
// import Image from "next/image"
// import { BookAIcon, Bot, Calendar, Computer, Dot, Home, Settings } from "lucide-react"

// export async function AppSidebar() {
//   const session = await auth()

//   // * Check this cond. maybe here is the reloading blank page issue
//   if (!session?.user?.name) {
//     return <SignIn />
//   }
...
//               <SidebarMenuItem key={1} className="text-left">
...
//                     <Home className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Principal</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>

//               <SidebarMenuItem key={2} className="text-left">
//                 <SidebarMenuButton asChild className="xl:w-[210px] 2xl:w-[230px] hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black font-roboto">
//                   <a href="/inicio/mis-clases-virtuales" className="">
//                     <Computer className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Clases Virtuales</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>

//               <SidebarMenuItem key={3} className="text-left">
//                 <SidebarMenuButton asChild className="xl:w-[210px] 2xl:w-[230px] hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black font-roboto">
//                   <a href="/inicio/actividades" className="">
//                     <Bot className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Actividades</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>

//               <SidebarMenuItem key={4} className="text-left">
//                 <SidebarMenuButton asChild className="xl:w-[210px] 2xl:w-[230px] hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black font-roboto">
//                   <a href="/inicio/calendario" className="">
//                     <Calendar className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Calendario</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>

//               <SidebarMenuItem key={5} className="text-left">
//                 <SidebarMenuButton asChild className="xl:w-[210px] 2xl:w-[230px] hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black font-roboto">
//                   <a href="/inicio/reservas" className="">
//                     <BookAIcon className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Reservas</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>

//               <SidebarMenuItem key={6} className="text-left">
//                 <SidebarMenuButton asChild className="xl:w-[210px] 2xl:w-[230px] hover:text-white hover:bg-black dark:hover:bg-white dark:hover:text-black font-roboto">
//                   <a href="/inicio/configuracion" className="">
//                     <Settings className="" />
//                     <span className="lg:text-lg text-xl tracking-wider font-bold xl:font-medium 2xl:font-medium">Configuracion</span>
//                   </a>
//                 </SidebarMenuButton>
//               </SidebarMenuItem>
