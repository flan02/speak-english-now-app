...
function Card({ title, description }: { title: string, description: string }) {
  return (
    <div className="bg-amber-100/30 lg:border-none space-y-8 hover:bg-amber-100/40 bg-card px-4 py-6 lg:py-12 rounded-lg shadow hover:shadow-lg transition dark:border dark:border-purple-900/50">
