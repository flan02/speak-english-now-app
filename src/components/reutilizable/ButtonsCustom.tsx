...
export function LinkedInButton() {
  return (
    <a
      ...
      className="flex items-center justify-center gap-2 px-6 py-2 rounded-xl bg-[#0A66C2] text-white hover:bg-[#19548f] transition-colors duration-300 shadow-md"
    >
      <Linkedin className="w-5 h-5" />
      <span className="text-lg mt-1 font-bold">LinkedIn</span>
    </a>
  );
}
...
export function MyWebsiteButton() {
  return (
    <a
      ...
      target="_blank"
      className="w-full relative inline-flex items-center justify-center px-6 py-3 rounded-xl text-white font-semibold shadow-lg overflow-hidden transition-all duration-300
    ...
    >
      ...
      <span className="relative z-10 text-lg ml-2">Mi Website</span>
    </a>
  );
}