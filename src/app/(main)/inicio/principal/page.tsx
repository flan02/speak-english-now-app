                ...
                <article className='flex justify-between'>
                  {
                    lastClass && new Date(lastClass.endTime) > new Date() ?
                      ...
                      :
                      <p className='px-2 xl:px-6 2xl:px-6 py-2 font-bold font-roboto text-sm xl:mx-4 2xl:mx-4 border border-card w-full rounded-lg'><span className='underline'>Siguiente clase</span>: &nbsp;No tenes clases programadas</p>
                  }
