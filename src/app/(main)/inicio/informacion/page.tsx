...
const InformacionPage = async (props: Props) => {
  return (
    <div className='py-12 space-y-8'>
      ...
      <h1 className='font-bold text-3xl mb-8 text-center'>Informacion sobre las clases abiertas</h1>
      <div className="space-y-6 font-roboto border border-card rounded-md px-3 py-10 font-bold xl:text-base 2xl:text-base xl:px-8 xl:py-8 2xl:px-8 2xl:py-10 xl:tracking-wider 2xl:tracking-wider text-left xl:text-justify">
