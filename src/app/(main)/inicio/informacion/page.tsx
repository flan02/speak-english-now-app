  ...
  return (
    <div className='py-12 space-y-8'>
      <div className="flex justify-end mr-8">
        <Link href={URL_ROUTES.INICIO} className='underline'>
          <ArrowLeftCircle />
        </Link>
      </div>
      <h1 className='font-bold text-xl mb-8 text-center'>Informacion sobre las clases abiertas</h1>
      <div className="space-y-6 font-roboto border border-card rounded-md mx-1 px-3 py-10 font-bold text-sm leading-6 xl:text-base 2xl:text-base xl:px-8 xl:py-8 2xl:px-8 2xl:py-10 xl:tracking-wider 2xl:tracking-wider text-left xl:text-justify">
        ...
        <p>Cada clase tendra una duracion de 60 minutos y se enfocara en diferentes aspectos del aprendizaje del ingles, separado en distintos niveles: La gramatica del idioma basica y avanzada,
        ...
        <p>Para participar en cada clases abierta, los asistentes deben inscribirse previamente a traves de la plataforma para reservar su lugar el precio de cada clase es ${pricing.openClassPrice} ARS
          y el room estara limitado a 100 participantes.
          Una vez inscriptos, en la seccion <a href={URL_ROUTES.CLASES_VIRTUALES} className='underline underline-offset-2'>clases virtuales</a> tendran la informacion de la clase y el codigo unico de acceso.</p>
