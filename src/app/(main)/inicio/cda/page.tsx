        ...
        <article className="mt-12 px-2 lg:px-4 h-full">
          <div className="text-center mb-6">
            <div className='font-bold text-xs lg:text-sm font-roboto flex space-x-2'>
              <School />
              <h3 className="mt-1.5">Tutoriales</h3>
            </div>
            <p className="text-muted-foreground text-xs lg:text-sm font-roboto">Aprende a usar la plataforma con nuestras guías rápidas.</p>
          </div>
          <TutorialsList />
        </article>
      </Card>
