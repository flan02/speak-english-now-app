                ...
                <article className='flex justify-between'>
                  {
                    lastClass && new Date(lastClass.endTime) > new Date() ?
                      <div className='bg-black/90 text-white dark:bg-white dark:text-black rounded-lg min-w-[345px] xl:w-full 2xl:w-full flex justify-around items-start flex-col px-2 xl:items-center 2xl:items-center xl:flex-row 2xl:flex-row space-x-2 xl:px-2 xl:text-xs 2xl:px-4 2xl:text-sm font-roboto border border-card mx-auto xl:mx-4 2xl:mx-4 py-6 xl:py-0 2xl:py-0'>
                        ...
                        <div className='flex items-center space-x-2 text-sm'>
                          ...
                          <p className='font-roboto'>{calcularTiempoRestante(lastClass.startTime)}</p>
                        </div>
                      </div>
                      :
